# Task: Hatch a complete Codex pet — Apollo, sticker edition
...
- Pet id: `apollo-sticker`
- Display name: `Apollo (Sticker)`
...
- /Users/mcreenan/dog-pet-photos/variants/apollo-sticker.png — canonical approved base look

## Run parameters

- Run directory: /Users/mcreenan/dog-pet-photos/runs/sticker
...
- Package to `~/.codex/pets/apollo-sticker/` (pet.json + spritesheet.webp).
