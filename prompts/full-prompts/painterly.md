# Task: Hatch a complete Codex pet — Apollo, painterly edition
...
- Pet id: `apollo-painterly`
- Display name: `Apollo (Painterly)`
...
- /Users/mcreenan/dog-pet-photos/variants/apollo-painterly.png — canonical approved base look

## Run parameters

- Run directory: /Users/mcreenan/dog-pet-photos/runs/painterly
...
- Package to `~/.codex/pets/apollo-painterly/` (pet.json + spritesheet.webp).
