# Task: Hatch a complete Codex pet — Apollo, flat-vector edition
...
- Pet id: `apollo-flat-vector`
- Display name: `Apollo (Flat Vector)`
...
- /Users/mcreenan/dog-pet-photos/variants/apollo-flat-vector.png — canonical approved base look
...
- Package to `~/.codex/pets/apollo-flat-vector/` (pet.json + spritesheet.webp).
