# Task: Hatch a complete Codex pet — Apollo, clay edition
...
- /Users/mcreenan/dog-pet-photos/variants/apollo-clay.png — canonical approved base look

## Run parameters

- Run directory: /Users/mcreenan/dog-pet-photos/runs/clay
...
- Package to `~/.codex/pets/apollo-clay/` (pet.json + spritesheet.webp).
