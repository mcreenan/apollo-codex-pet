# Task: Hatch a complete Codex pet — Apollo, {STYLE} edition
...
- /Users/mcreenan/dog-pet-photos/variants/apollo-{STYLE}.png — canonical approved base look

## Run parameters

- Run directory: /Users/mcreenan/dog-pet-photos/runs/{STYLE}
...
- Package to `~/.codex/pets/apollo-{STYLE}/` (pet.json + spritesheet.webp).
